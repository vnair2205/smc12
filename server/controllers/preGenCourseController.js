...
exports.startCourse = async (req, res) => {
    try {
        ...
        // 3. Create a new personal copy for the user
        const { _id, category, subCategory1, subCategory2, ...courseData } = templateCourse;
        
        const newCourse = new Course({
            ...courseData,
            user: userId,
            preGenCourseOrigin: preGenCourseId, // Link back to the template
            status: 'Active',
            createdAt: new Date(),
        });
