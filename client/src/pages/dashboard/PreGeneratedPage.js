    ...
    return (
        <PageContainer>
            <HeaderContainer>
                ...
                <TabContainer>
                    <TabButton isActive={activeTab === 'all'} onClick={() => setActiveTab('all')}>All Courses</TabButton>
                    <TabButton isActive={activeTab === 'my'} onClick={() => setActiveTab('my')}>My Courses</TabButton>
                </TabContainer>
            </HeaderContainer>

            {activeTab === 'all' ? <AllPreGenCoursesTab /> : <MyPreGenCoursesTab />}
        </PageContainer>
    );
};
